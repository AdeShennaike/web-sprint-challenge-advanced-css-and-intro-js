...
function get20s(array) {
  ...
  for(let i = 0; i < array.length; i++){
    if(array[i].years.split(' ',3) >= '1900' && array[i].years.split(' ',3) <= '2000'){
    artTwenty.push(array[i].name);
    }
  }
  return artTwenty;
}
...
function addArtist(array) {
  array.push({ 
    ...
    genre: 'Web Metal', 
    nationality: 'Cartoon',
    bio: 'Was born from an nigerian born mom with a guitar in his hand at birth!'
  }  )
  return array;
}
